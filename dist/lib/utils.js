...
function constructMetadata(_a) {
    ...
    return __assign({ title: title, description: description, openGraph: {
        ...
        }, icons: icons, metadataBase: new URL("https://phoenixvalormarket.onrender.com/") }, (noIndex && {
        robots: {
            index: false,
            follow: false,
        },
